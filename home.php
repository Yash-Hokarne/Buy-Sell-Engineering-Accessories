...
<html>
    ...
    <body id="index_body">
        ...
        <div name="navbar">
            <ul>
                <li class="index_ul_li" style="margin:10px"><a class="index_a" href="home.php">Home</a></li>
                ...
                <li class="index_ul_li" style="margin:10px"><a class="index_a" href="my_cart.php" id="cart"><abbr title="Click to view/Single click to go back">Cart</abbr></a></li>
                ...
                <li class="index_ul_li" style="margin:10px"><a class="index_a" href="my_orders.php" id="myorders"><abbr title="Click to view/Single click to go back">My Orders</abbr></a></li>
            </ul>
        </div>
                                    ...
                                    <?php
                                        ...
                                        if($res1->num_rows>0){
                                            ...
                                            while ($row=$res1->fetch_assoc()){
                                                ...
                                                $row["SellerContact"]."</td><td><button><a href='add_to_cart.php'>Add to Cart</a></button><br><br><button><a href='buy_now.php'>Buy Now</a></button></td></tr>";
                                            }
                                            echo"</table>";
                                        }
                                        else{
                                    ...
                                    <?php
                                        ...
                                        if($res1->num_rows>0){
                                            ...
                                            while ($row=$res1->fetch_assoc()){
                                                ...
                                                echo "<tr><td>".$row["PID"]."</td><td>".$row["UID"]."</td><td>".$row["ProductName"]."</td><td><img src='data:image/jpeg/png;base64,'".base64_encode($row['ProductImage'])."</td><td>".
                                                $row["ProductCategory"]."</td><td>".$row["ProductDescription"]."</td><td>".$row["ProductPrice"]."</td><td>".
                                                $row["SellerContact"]."</td><td><button><a href='add_to_cart.php'>Add to Cart</a></button><br><button><a href='buy_now.php'>Buy Now</a></button></td></tr>";
                                            }
                                            echo"</table>";
                                        }
                                        else{
